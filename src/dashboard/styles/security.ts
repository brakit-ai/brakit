...
/* All-clear */
.sec-clear{display:flex;align-items:center;gap:16px;padding:20px 24px;background:rgba(74,222,128,.06);border:1px solid rgba(74,222,128,.2);border-radius:var(--radius);margin-bottom:24px}
.sec-clear-icon{font-size:24px;color:var(--green);flex-shrink:0}
.sec-clear-title{font-size:16px;font-weight:600;color:var(--green);margin-bottom:2px}
.sec-clear-sub{font-size:13px;color:var(--text-dim)}

/* Summary bar */
.sec-summary{display:flex;align-items:center;justify-content:space-between;padding:14px 18px;background:var(--bg-card);border:1px solid var(--border);border-radius:var(--radius);margin-bottom:20px}
.sec-summary-left{display:flex;align-items:baseline;gap:8px}
.sec-summary-count{font-size:24px;font-weight:700;font-family:var(--mono);color:var(--text)}
.sec-summary-label{font-size:13px;color:var(--text-dim)}
...
/* Hint */
.sec-hint{padding:8px 16px;font-size:12px;color:var(--text-muted);background:var(--bg);border-bottom:1px solid var(--border)}

/* Items */
.sec-items{padding:4px 0}
.sec-item{display:flex;align-items:center;justify-content:space-between;padding:8px 16px;font-size:13px;transition:background .1s}
...
.sec-item-count{font-size:11px;font-family:var(--mono);color:var(--text-muted);flex-shrink:0;margin-left:12px}
`;
}
